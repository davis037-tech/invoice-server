...
from .db_bootstrap import ensure_invoice_columns, ensure_tenant_and_user_columns, ensure_settings_columns, ensure_plan_limits_seeded, ensure_pdf_tables_seeded
...
def create_app():
    ...
    ensure_pdf_tables_seeded(app, db)
